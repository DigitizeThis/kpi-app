...
export default function Storyboards({ kpis }: KpisPropsAll) {
    return (
        <div className="container mx-auto flex flex-row flex-wrap px-2 justify-center items-center">
            ...
            <Container>
                ...
                <MainLayout kpis={kpis!} title="Storyboards" abstract="Top Storyboard picks from the week" />
                <section className="flex flex-row flex-wrap my-10 mx-0 justify-left">
                    <div className="w-full">
                        <h2 className="text-4xl text-left">Storyboards</h2>
                        <h5 className="text-base font-normal text-gray-500 mb-5">
                            <small>Top Storyboard picks from the week</small>
                        </h5>
